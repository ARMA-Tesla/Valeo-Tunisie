 ...
 */
	...
	viCheckDAQ( DAQmxCfgInputBuffer (psessions->ai, samples_per_channel*20));
	viCheckDAQ( DAQmxRegisterEveryNSamplesEvent( psessions->ai,
			  								     DAQmx_Val_Acquired_Into_Buffer,
												 samples_per_channel,0,EveryNCallback,
												 (void*)vi));

	viCheckDAQ (DAQmxRegisterDoneEvent( psessions->ai, 0, DoneCallback, (void*)vi));
