...
#define LABEL_MAX_TEXT_RESULT				32
...
typedef struct _SLabelList {
	...
	SElExceptionPtr (*GetBarCodeStatus)(struct _SLabelList*	me,
										...
										bool_t*				tested,
										bool_t*				failed);
	SElExceptionPtr (*GetBarCodeHousingStatus)(struct _SLabelList*	me,
										const char*			barCode, 
										bool_t*				tested,
										bool_t*				failed);
	SElExceptionPtr (*GetBarCodeTopCoverStatus)(struct _SLabelList*	me,
										const char*			barCode, 
										bool_t*				tested,
										bool_t*				failed);
