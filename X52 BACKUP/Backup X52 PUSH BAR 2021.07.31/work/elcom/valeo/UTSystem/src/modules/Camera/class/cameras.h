...
typedef struct _Camera
{
	...
	SElExceptionPtr (*Cognex_set_parameters)(struct _Camera* me, char* colonne, int phase);
	SElExceptionPtr (*Cognex_set_parameters_VS11)(struct _Camera* me, char* colonne, int phase);
	...
	SElExceptionPtr (*_Cognex_set_number_bouttonSpec)(struct _Camera* me, int phase); 
	SElExceptionPtr (*_Cognex_set_parametersSpec)(struct _Camera* me, char* colonne, int phase);
	SElExceptionPtr (*_Cognex_set_parameters_VS11Spec)(struct _Camera* me, char* colonne, int phase);
