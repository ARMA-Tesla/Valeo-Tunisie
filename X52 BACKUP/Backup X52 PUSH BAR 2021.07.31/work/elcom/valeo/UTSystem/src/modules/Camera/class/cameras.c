...
static SElExceptionPtr camera_Cognex_set_parameters(SCameraPtr me, char* colonne, int phase);
static SElExceptionPtr camera_Cognex_set_parameters_VS11(SCameraPtr me, char* colonne, int phase);
...
)
{
	...
	pnewcamera->Cognex_set_parameters_VS11		= camera_Cognex_set_parameters_VS11;
...
)
{
	...
	if (me->specLib == 0)
	{
		...
		me->_Cognex_set_parameters_VS11Spec	= (SElExceptionPtr (*)(SCameraPtr,char *,int))
								GetProcAddress(me->specLib, "Cognex_set_parameters_VS11");
...
Error:
	if (pexception)
	{
		...
		me->_Cognex_set_parameters_VS11Spec= NULL;
	}
...
static SElExceptionPtr camera_Cognex_set_parameters(SCameraPtr me, char* colonne, int phase)
{
	...
	if (me->_Cognex_set_parametersSpec)
		EXCCHECK( me->_Cognex_set_parametersSpec(me,colonne,phase));
...
#undef __FUNC__
#define __FUNC__ "{Camera}::Cognex_set_parameters_VS11"
static SElExceptionPtr camera_Cognex_set_parameters_VS11(SCameraPtr me, char* colonne, int phase)
{
	SElExceptionPtr	pexception = NULL;


	if (me->_Cognex_set_parameters_VS11Spec)
		EXCCHECK( me->_Cognex_set_parameters_VS11Spec(me,colonne,phase));
