...
#undef __FUNC__
#define __FUNC__	"X95_CAREG::Initialize"
...
)
{
	...
	EXCCHECKCOM( MSXML_IXMLDOMDocumentselectNodes (xml_doc, NULL,
						"//module[@id='"MODULE_JIG_X95_CAREG"']/Sensors/Sensor",
						&sensors_list));
	...
	EXCCHECKCOM( MSXML_IXMLDOMDocumentselectNodes (xml_doc, NULL,
						"//module[@id='"MODULE_JIG_X95_CAREG"']/BarCodeReaders/BarCodeReader",
						&bcr_list));
	if (bcr_list)
	{
...
#undef __FUNC__
#define __FUNC__	"X95_CAREG::Destroy"
...
#undef __FUNC__
#define __FUNC__	"X95_CAREG::GetUUID"
SElExceptionPtr GetUUID(struct _SJig* me, char* uuid, uint32_t size)
{
	SElExceptionPtr	pexception = NULL;
	
	strncpy(uuid, MODULE_JIG_X95_CAREG, size);
...
/* Lock product */
#undef __FUNC__
#define __FUNC__	"X95_CAREG::LockItem"
...
/* Unlock product */
#undef __FUNC__
#define __FUNC__	"X95_CAREG::UnlockItem"
...
#undef __FUNC__
#define __FUNC__	"X95_CAREG::ConnectToItem"
...
#undef __FUNC__
#define __FUNC__	"X95_CAREG::DisconnectFromItem"
...
/* Connectors disconnect from product */
#undef __FUNC__
#define __FUNC__	"X95_CAREG::ColdMarking"
...
#undef __FUNC__
#define __FUNC__	"X95_CAREG::SetItemPosition"
...
/* Get JIG position */
#undef __FUNC__
#define __FUNC__	"X95_CAREG::GetItemPosition"
...
#undef __FUNC__
#define __FUNC__	"X95_CAREG::GetItemCode"
...
#undef __FUNC__
#define __FUNC__	"X95_CAREG::GetSensor"
...
#undef __FUNC__
#define __FUNC__	"X95_CAREG::SetSensor"
...
/* Get Attribute Int32 */
#undef __FUNC__
#define __FUNC__	"X95_CAREG::GetAttributeInt32"
...
/* Set Attribute Int32 */
#undef __FUNC__
#define __FUNC__	"X95_CAREG::SetAttributeInt32"
...
#undef __FUNC__
#define __FUNC__	"X95_CAREG::GetAttributeBoolean"
...
#undef __FUNC__
#define __FUNC__	"X95_CAREG::SetAttributeBoolean"
...
#undef __FUNC__
#define __FUNC__	"X95_CAREG::JigThread"
