...
FCE_TEST(CMFB, 40_20)
{
	...
	EXCCHECK( MoveToPush(paxiss, AXIS_STATION_40, 0, 24.5, 44.0, 35.0));  //PUSH 2
	EXCCHECK( MoveToPush(paxiss, AXIS_STATION_40, 1, 24.5, 44.0, 35.0));  //PUSH 2
...
FCE_TEST(CMFB, 40_30)
{
	...
	EXCCHECK( MoveToPush(paxiss, AXIS_STATION_40, 0, 24.5, 44.0, 56.8));  //PUSH 3
	EXCCHECK( MoveToPush(paxiss, AXIS_STATION_40, 1, 24.5, 44.0, 56.8));  //PUSH 3
...
FCE_TEST(CMFB, 50_20)
{
    ...
    EXCCHECK(MoveToPush(paxiss, AXIS_STATION_50, 0, 27.5, 44.0, 166.1));  //PUSH 7   old Y=43 old X= 165.1
	EXCCHECK( MoveToPush(paxiss, AXIS_STATION_50, 1, 27.5, 44.0, 166.1));  //PUSH 7	
...
FCE_TEST(CMFB, 50_30)
{
	...
	EXCCHECK(MoveToPush(paxiss, AXIS_STATION_50, 0, 26.0, 44.0, 144.2));  //PUSH 6		Old Y=43
	EXCCHECK( MoveToPush(paxiss, AXIS_STATION_50, 1, 26.0, 44.0, 144.2));  //PUSH 6
	 Sleep(500); 
Error:
    TEST_END_STATION(STATION_50);
}
