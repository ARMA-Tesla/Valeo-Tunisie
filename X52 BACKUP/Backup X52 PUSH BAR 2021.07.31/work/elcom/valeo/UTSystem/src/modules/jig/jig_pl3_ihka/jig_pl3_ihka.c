...
#undef __FUNC__
#define __FUNC__	"PL3_IHKA::Initialize"
...
)
{
	...
	EXCCHECKCOM( MSXML_IXMLDOMDocumentselectNodes (xml_doc, NULL,
						"//module[@id='"MODULE_JIG_PL3_IHKA"']/Sensors/Sensor",
						&sensors_list));
	...
	EXCCHECKCOM( MSXML_IXMLDOMDocumentselectNodes (xml_doc, NULL,
						"//module[@id='"MODULE_JIG_PL3_IHKA"']/BarCodeReaders/BarCodeReader",
						&bcr_list));
	if (bcr_list)
	{
...
#undef __FUNC__
#define __FUNC__	"PL3_IHKA::Destroy"
...
#undef __FUNC__
#define __FUNC__	"PL3_IHKA::GetUUID"
SElExceptionPtr GetUUID(struct _SJig* me, char* uuid, uint32_t size)
{
	SElExceptionPtr	pexception = NULL;
	
	strncpy(uuid, MODULE_JIG_PL3_IHKA, size);
...
/* Lock product */
#undef __FUNC__
#define __FUNC__	"PL3_IHKA::LockItem"
...
/* Unlock product */
#undef __FUNC__
#define __FUNC__	"PL3_IHKA::UnlockItem"
...
#undef __FUNC__
#define __FUNC__	"PL3_IHKA::ConnectToItem"
...
#undef __FUNC__
#define __FUNC__	"PL3_IHKA::DisconnectFromItem"
...
/* Connectors disconnect from product */
#undef __FUNC__
#define __FUNC__	"PL3_IHKA::ColdMarking"
...
#undef __FUNC__
#define __FUNC__	"PL3_IHKA::SetItemPosition"
...
/* Get JIG position */
#undef __FUNC__
#define __FUNC__	"PL3_IHKA::GetItemPosition"
...
#undef __FUNC__
#define __FUNC__	"PL3_IHKA::GetItemCode"
...
#undef __FUNC__
#define __FUNC__	"PL3_IHKA::GetSensor"
...
#undef __FUNC__
#define __FUNC__	"PL3_IHKA::SetSensor"
...
/* Get Attribute Int32 */
#undef __FUNC__
#define __FUNC__	"PL3_IHKA::GetAttributeInt32"
...
/* Set Attribute Int32 */
#undef __FUNC__
#define __FUNC__	"PL3_IHKA::SetAttributeInt32"
...
#undef __FUNC__
#define __FUNC__	"PL3_IHKA::GetAttributeBoolean"
...
#undef __FUNC__
#define __FUNC__	"PL3_IHKA::SetAttributeBoolean"
...
#undef __FUNC__
#define __FUNC__	"PL3_IHKA::JigThread"
