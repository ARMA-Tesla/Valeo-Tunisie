...
#define STEP_CUSTOMER_INTERFACE  	4
...
STestListItem gs_TestList[] = {
	...
	ADD_TI( "40.31", CMFB, 40_70),	       /* test Force/Contact Push Nr3 X52_7*/
	ADD_TI( "40.319", CMFB, 40_709),	   /* test Force/Contact Push Nr3 X52_9*/
	...
	ADD_TI( "50.110", CMFB, 50_700),	/* test Force/Contact Push Nr8 VS11*/
	ADD_TI( "50.200", CMFB, 50_200),	/* position Push Nr7 VS11*/
	ADD_TI( "50.210", CMFB, 50_700),	/* test Force/Contact Push Nr7 VS11*/
   	ADD_TI( "50.300", CMFB, 50_300),	/* position Push Nr6 VS11*/
	ADD_TI( "50.310", CMFB, 50_700),	/* test Force/Contact Push Nr6 VS11*/
   	ADD_TI( "50.400", CMFB, 50_400),	/* position Push Nr5 VS11*/
	ADD_TI( "50.410", CMFB, 50_700),	/* test Force/Contact Push Nr5 VS11*/
...
FCE_TEST(CMFB, 20_400)
{
	...
	checkErr( eldaq_GetChannelScale ( vi_DAQ2, "ai1", "distance", (void *)&pScaleInfo));
	EXCCHECK( ReadAnalogWithScale2("","ai1", pScaleInfo, &rvalue));
	level = (float)(rvalue - 1.7);
	LIMIT_CHECK(REAL64, level);
	
	checkErr( eldaq_GetChannelScale ( vi_DAQ2, "ai2", "distance", (void *)&pScaleInfo));
	EXCCHECK( ReadAnalogWithScale2("","ai2", pScaleInfo, &rvalue));
	level = (float)(rvalue - 1.38);
	level=0;
	LIMIT_CHECK(REAL64, level);

	checkErr( eldaq_GetChannelScale ( vi_DAQ2, "ai3", "distance", (void *)&pScaleInfo));
	EXCCHECK( ReadAnalogWithScale2("","ai3", pScaleInfo, &rvalue));
	level = (float)(rvalue - 1.0);
	LIMIT_CHECK(REAL64, level);
	
	checkErr( eldaq_GetChannelScale ( vi_DAQ2, "ai4", "distance", (void *)&pScaleInfo));
	EXCCHECK( ReadAnalogWithScale2("","ai4", pScaleInfo, &rvalue));
	level = (float)(rvalue - 1.14);
	level=0;
	LIMIT_CHECK(REAL64, level);
	
	checkErr( eldaq_GetChannelScale ( vi_DAQ2, "ai5", "distance", (void *)&pScaleInfo));
	EXCCHECK( ReadAnalogWithScale2("","ai5", pScaleInfo, &rvalue));
	level = (float)(rvalue - 0.96);
	LIMIT_CHECK(REAL64, level);
	
	checkErr( eldaq_GetChannelScale ( vi_DAQ2, "ai6", "distance", (void *)&pScaleInfo));
	EXCCHECK( ReadAnalogWithScale2("","ai6", pScaleInfo, &rvalue));
	level = (float)(rvalue - 1.02);
	level=0;						   ////////////
	LIMIT_CHECK(REAL64, level);
	
	checkErr( eldaq_GetChannelScale ( vi_DAQ2, "ai7", "distance", (void *)&pScaleInfo));
	EXCCHECK( ReadAnalogWithScale2("","ai7", pScaleInfo, &rvalue));
	level = (float)(rvalue - 2.11);
	level=0;						  ////////////
	LIMIT_CHECK(REAL64, level);
	
	checkErr( eldaq_GetChannelScale ( vi_DAQ2, "ai8", "distance", (void *)&pScaleInfo));
	EXCCHECK( ReadAnalogWithScale2("","ai8", pScaleInfo, &rvalue));
	level = (float)(rvalue - 3.19); 
	LIMIT_CHECK(REAL64, level);
	
	checkErr( eldaq_GetChannelScale ( vi_DAQ2, "ai9", "distance", (void *)&pScaleInfo));
	EXCCHECK( ReadAnalogWithScale2("","ai9", pScaleInfo, &rvalue));
	level = (float)(rvalue - 2.21);  
	LIMIT_CHECK(REAL64, level);
	
	checkErr( eldaq_GetChannelScale ( vi_DAQ2, "ai10", "distance", (void *)&pScaleInfo));
	EXCCHECK( ReadAnalogWithScale2("","ai10", pScaleInfo, &rvalue));
	level = (float)(rvalue - 2.75);
	level=0;					  //////////
	LIMIT_CHECK(REAL64, level);
	
	checkErr( eldaq_GetChannelScale ( vi_DAQ2, "ai11", "distance", (void *)&pScaleInfo));
	EXCCHECK( ReadAnalogWithScale2("","ai11", pScaleInfo, &rvalue));
	level = (float)(rvalue - 1.71);
	LIMIT_CHECK(REAL64, level);
	
	checkErr( eldaq_GetChannelScale ( vi_DAQ2, "ai12", "distance", (void *)&pScaleInfo));
	EXCCHECK( ReadAnalogWithScale2("","ai12", pScaleInfo, &rvalue));
	level = (float)(rvalue - 2.91);   
	LIMIT_CHECK(REAL64, level);
	
	checkErr( eldaq_GetChannelScale ( vi_DAQ2, "ai13", "distance", (void *)&pScaleInfo));
	EXCCHECK( ReadAnalogWithScale2("","ai13", pScaleInfo, &rvalue));
	level = (float)(rvalue - 2.41);
	level=0;					  /////////
	LIMIT_CHECK(REAL64, level);
...
FCE_TEST(CMFB, 20_409)
{
	...
	checkErr( eldaq_GetChannelScale ( vi_DAQ2, "ai0", "distance", (void *)&pScaleInfo));
	EXCCHECK( ReadAnalogWithScale2("","ai0", pScaleInfo, &rvalue));
	level = (float)(rvalue - 2.08);
	LIMIT_CHECK(REAL64, level);
	
	/* PTZ 13 */
	checkErr( eldaq_GetChannelScale ( vi_DAQ2, "ai1", "distance", (void *)&pScaleInfo));
	EXCCHECK( ReadAnalogWithScale2("","ai1", pScaleInfo, &rvalue));
	level = (float)(rvalue - 2.7);
	level=0;
	LIMIT_CHECK(REAL64, level);
...
FCE_TEST(CMFB, 40_19)
{
	...
	/* Get Scale info for analog channels */
	checkErr( eldaq_GetChannelScale ( vi_DAQ, "ai1", "force", (void *)&pScaleInfoForce_Station_40)); //Force Sensor 
	checkErr( eldaq_GetChannelScale ( vi_DAQ, "ai16", "voltage", (void *)&pScaleInfo1_Station_40));  //PUSH 1 VS11
	checkErr( eldaq_GetChannelScale ( vi_DAQ, "ai15", "voltage", (void *)&pScaleInfo2_Station_40));  //PUSH 2 VS11
	checkErr( eldaq_GetChannelScale ( vi_DAQ, "ai13", "voltage", (void *)&pScaleInfo3_Station_40));  //PUSH 3 VS11
	checkErr( eldaq_GetChannelScale ( vi_DAQ, "ai14", "voltage", (void *)&pScaleInfo4_Station_40));  //PUSH 4 VS11
	checkErr( eldaq_GetChannelScale ( vi_DAQ, "ai11", "voltage", (void *)&pScaleInfo5_Station_40));  //PUSH 5 VS11
	checkErr( eldaq_GetChannelScale ( vi_DAQ, "ai22", "voltage", (void *)&pScaleInfo6_Station_40));  //PUSH 6 VS11
	checkErr( eldaq_GetChannelScale ( vi_DAQ, "ai23", "voltage", (void *)&pScaleInfo7_Station_40));  //PUSH 7 VS11
	checkErr( eldaq_GetChannelScale ( vi_DAQ, "ai10", "voltage", (void *)&pScaleInfo8_Station_40));  //PUSH 8 VS11
...
FCE_TEST(CMFB, 40_70)
{
	...
	/* Peak force F1 */
	dmF1V=dmF1V-0.00;	// Ajout Offset ici
...
FCE_TEST(CMFB, 40_109)
{
	...
	//EXCCHECK( MoveToPush(paxiss, 0, 0, 30.0, 37.5, 45.10));  //PUSH 1
	//EXCCHECK( MoveToPush(paxiss, 0, 1, 30.0, 37.5, 45.10));  //PUSH 1

	EXCCHECK( MoveToPush(paxiss, 0, 0, 26.5, 43.0, 13.0));  //PUSH 1
	EXCCHECK( MoveToPush(paxiss, 0, 1, 26.5, 43.0, 13.0));  //PUSH 1
	Sleep(500); 
Error:
    TEST_END_STATION(STATION_40);
}
...
FCE_TEST(CMFB, 40_20)
{
	...
	//EXCCHECK( MoveToPush(paxiss, 0, 0, 30.0, 37.5, 66.27));  //PUSH 2
	//EXCCHECK( MoveToPush(paxiss, 0, 1, 30.0, 37.5, 66.27));  //PUSH 2
	
	EXCCHECK( MoveToPush(paxiss, 0, 0, 26.5, 43.0, 35.0));  //PUSH 2
	EXCCHECK( MoveToPush(paxiss, 0, 1, 26.5, 43.0, 35.0));  //PUSH 2
	Sleep(500);
Error:
    TEST_END_STATION(STATION_40);
}
...
FCE_TEST(CMFB, 40_209)
{
	...
	EXCCHECK( MoveToPush(paxiss, 0, 0, 26.5, 43.0, 34.9));  //PUSH 2
	EXCCHECK( MoveToPush(paxiss, 0, 1, 26.5, 43.0, 34.9));  //PUSH 2
	Sleep(500);
Error:
    TEST_END_STATION(STATION_40);
}
...
FCE_TEST(CMFB, 40_30)
{
	...
	//EXCCHECK( MoveToPush(paxiss, 0, 0, 30.0, 37.5, 87.44));  //PUSH 3
	//EXCCHECK( MoveToPush(paxiss, 0, 1, 30.0, 37.5, 87.44));  //PUSH 3
	
	EXCCHECK( MoveToPush(paxiss, 0, 0, 26.5, 43.0, 56.8));  //PUSH 3
	EXCCHECK( MoveToPush(paxiss, 0, 1, 26.5, 43.0, 56.8));  //PUSH 3
	Sleep(500); 
...
FCE_TEST(CMFB, 40_100)
{
	...
	EXCCHECK( MoveToPush(paxiss, 0, 0, 27.0, 43.0, 22.0));  //PUSH 1
	EXCCHECK( MoveToPush(paxiss, 0, 1, 27.0, 43.0, 22.0));  //PUSH 1
	Sleep(500); 
Error:
    TEST_END_STATION(STATION_40);
}
...
FCE_TEST(CMFB, 40_200)
{
	...
	EXCCHECK( MoveToPush(paxiss, 0, 0, 27.0, 43.0, 44.0));  //PUSH 2
	EXCCHECK( MoveToPush(paxiss, 0, 1, 27.0, 43.0, 44.0));  //PUSH 2
	Sleep(500);
Error:
    TEST_END_STATION(STATION_40);
}
...
FCE_TEST(CMFB, 40_300)
{
	...
	EXCCHECK( MoveToPush(paxiss, 0, 0, 27.0, 43.0, 66.0));  //PUSH 3
	EXCCHECK( MoveToPush(paxiss, 0, 1, 27.0, 43.0, 66.0));  //PUSH 3
	Sleep(500); 
...
FCE_TEST(CMFB, 40_400)
{
	...
	//EXCCHECK( MoveToPush(paxiss, 0, 0, 30.0, 37.5, 108.60));  //PUSH 4
	//EXCCHECK( MoveToPush(paxiss, 0, 1, 30.0, 37.5, 108.60));  //PUSH 4
			   	
	EXCCHECK( MoveToPush(paxiss, 0, 0, 27.0, 43.0, 88.0));  //PUSH 4
	EXCCHECK( MoveToPush(paxiss, 0, 1, 27.0, 43.0, 88.0));  //PUSH 4
   Sleep(500); 
Error:
    TEST_END_STATION(STATION_40);
}
...
FCE_TEST(CMFB, 40_700)
{
	...
	memset(Contactchannel, 0X00, 5); 
	PARAM_STRING_REQUIRED("AnalogChannel", Contactchannel);
//	printf("Contactchannel=%s\r\n",Contactchannel);
	Sleep(500);
	EXCCHECK( paxiss->GetaxisByIndex(paxiss, 2, &paxis));  // Modif Index Axis Ici ancien 0 nouveau 2
	
	/* Medium speed  ==> mouvement in direction + */
	paxis->SetPosition(paxis, AXIS_Z, 28.0, 10.0);
	paxis->SetPosition(paxis, AXIS_Z, 28.0, 10.0);
	paxis->EnableAxis(paxis, AXIS_Z);
...
{ 
	...
	EXCCHECK( paxiss->GetaxisByIndex(paxiss, 3, &paxis));   // Modif Index Axis Ancien 1 nouveau 3
...
FCE_TEST(CMFB, 50_19)
{
	...
	checkErr( eldaq_GetChannelScale ( vi_DAQ, "ai28", "voltage", (void *)&pScaleInfo1_Station_50));  //PUSH 1 VS11
	checkErr( eldaq_GetChannelScale ( vi_DAQ, "ai25", "voltage", (void *)&pScaleInfo2_Station_50));  //PUSH 2 VS11
	checkErr( eldaq_GetChannelScale ( vi_DAQ, "ai21", "voltage", (void *)&pScaleInfo3_Station_50));  //PUSH 3 VS11
	checkErr( eldaq_GetChannelScale ( vi_DAQ, "ai24", "voltage", (void *)&pScaleInfo4_Station_50));  //PUSH 4 VS11
	checkErr( eldaq_GetChannelScale ( vi_DAQ, "ai19", "voltage", (void *)&pScaleInfo5_Station_50));  //PUSH 5 VS11
	checkErr( eldaq_GetChannelScale ( vi_DAQ, "ai26", "voltage", (void *)&pScaleInfo6_Station_50));  //PUSH 6 VS11
	checkErr( eldaq_GetChannelScale ( vi_DAQ, "ai27", "voltage", (void *)&pScaleInfo7_Station_50));  //PUSH 7 VS11
	checkErr( eldaq_GetChannelScale ( vi_DAQ, "ai18", "voltage", (void *)&pScaleInfo8_Station_50));  //PUSH 8 VS11
...
FCE_TEST(CMFB, 50_70)
{
	...
	EXCCHECK( paxiss->GetaxisByIndex(paxiss, 3, &paxis)); // Modif Index Axis Ici ancien 1 nouveau 3
...
//	printf("data_Analog[2]=%f\r\n",data_Analog[2] ); 
	...
	/* Peak force F1 */
	//if (dmF1V<2.24)
	dmF1V=dmF1V;	 // Ajout Offset F1 ST50
	LIMIT_CHECK(REAL64, dmF1V);
...
Error:
	...
	{
		/:high speed  ==> mouvement in direction - 
		paxis->SetPosition(paxis, AXIS_Z, 29.0, 100.0);
		paxis->SetPosition(paxis, AXIS_Z, 29.0, 100.0);
		paxis->EnableAxis(paxis, AXIS_Z);
		return  pexception;
	}  */
...
//	 printf(" Offset_Force=%f\r\n",Offset_Force);
	...
	/*check voltage only one push pressed others pushs not pressed */
	EXCCHECK( ReadAnalogWithScale(Contactchannel, "ai18", pScaleInfo5_Station_50,&rvalue));
	LIMIT_CHECK(REAL64, rvalue);
...
FCE_TEST(CMFB, 50_109)
{
	...
	EXCCHECK( MoveToPush(paxiss, 1, 0, 25.5, 43.0, 187.0));  //PUSH 7
	EXCCHECK( MoveToPush(paxiss, 1, 1, 25.5, 43.0, 187.0));  //PUSH 7
	Sleep(500); 
...
FCE_TEST(CMFB, 50_20)
{
	...
	//EXCCHECK( MoveToPush(paxiss, 1, 0, 29.0, 37.1, 77.10));  //PUSH 7
	//EXCCHECK( MoveToPush(paxiss, 1, 1, 29.0, 37.1, 77.10));  //PUSH 7

    EXCCHECK(MoveToPush(paxiss, 1, 0, 27.5, 44.0, 166.1));  //PUSH 7   old Y=43 old X= 165.1
	EXCCHECK( MoveToPush(paxiss, 1, 1, 27.5, 44.0, 166.1));  //PUSH 7
	Sleep(500); 	
...
FCE_TEST(CMFB, 50_209)
{
	...
	EXCCHECK( MoveToPush(paxiss, 1, 0, 25.5, 44.0, 166.1));  //PUSH 7   old Y=43 old X= 165.1
	EXCCHECK( MoveToPush(paxiss, 1, 1, 25.5, 44.0, 166.1));  //PUSH 7
	Sleep(500); 	
...
FCE_TEST(CMFB, 50_309)
{
	...
	//EXCCHECK( MoveToPush(paxiss, 1, 0, 29.0, 37.1, 98.20));  //PUSH 6
	//EXCCHECK( MoveToPush(paxiss, 1, 1, 29.0, 37.1, 98.20));  //PUSH 6

	EXCCHECK( MoveToPush(paxiss, 1, 0, 25.5, 43.0, 144.2));  //PUSH 6		Old Y=43
	EXCCHECK( MoveToPush(paxiss, 1, 1, 25.5, 43.0, 144.2));  //PUSH 6
	 Sleep(500); 
Error:
    TEST_END_STATION(STATION_50);
}
...
FCE_TEST(CMFB, 50_30)
{
	...
	EXCCHECK(MoveToPush(paxiss, 1, 0, 26.0, 43.0, 144.2));  //PUSH 6		Old Y=43
	EXCCHECK( MoveToPush(paxiss, 1, 1, 26.0, 43.0, 144.2));  //PUSH 6
	 Sleep(500); 
Error:
    TEST_END_STATION(STATION_50);
}
...
FCE_TEST(CMFB, 50_400)
{
	...
	//EXCCHECK( MoveToPush(paxiss, 0, 0, 26.5, 43.0, 45.10));  //PUSH 5
	//EXCCHECK( MoveToPush(paxiss, 0, 1, 26.5, 43.0, 45.10));  //PUSH 5

	EXCCHECK( MoveToPush(paxiss, 1, 0, 26.0, 43.0, 176.9));  //PUSH 1
	EXCCHECK( MoveToPush(paxiss, 1, 1, 26.0, 43.0, 176.9));  //PUSH 1
	Sleep(500); 
Error:
    TEST_END_STATION(STATION_50);
}
...
FCE_TEST(CMFB, 50_300)
{
	...
	EXCCHECK( MoveToPush(paxiss, 1, 0, 26.0, 43.0, 154.9));  //PUSH 2
	EXCCHECK( MoveToPush(paxiss, 1, 1, 26.0, 43.0, 154.9));  //PUSH 2
	Sleep(500);
Error:
    TEST_END_STATION(STATION_50);
}
...
FCE_TEST(CMFB, 50_200)
{
	...
	EXCCHECK( MoveToPush(paxiss, 1, 0, 26.0, 43.0, 132.9));  //PUSH 3
	EXCCHECK( MoveToPush(paxiss, 1, 1, 26.0, 43.0, 132.9));  //PUSH 3
	Sleep(500); 
...
FCE_TEST(CMFB, 50_100)
{
	...
	EXCCHECK( MoveToPush(paxiss, 1, 0, 26.0, 43.0, 110.9));  //PUSH 4
	EXCCHECK( MoveToPush(paxiss, 1, 1, 26.0, 43.0, 110.9));  //PUSH 4
   Sleep(500); 
Error:
    TEST_END_STATION(STATION_50);
}
...
/*********************************************************************************
 * Function 60_09  Repérage Produit
*********************************************************************************/
