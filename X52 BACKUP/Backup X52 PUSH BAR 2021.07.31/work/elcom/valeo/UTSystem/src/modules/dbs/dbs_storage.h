...
typedef struct _SDBSStorage          
{
	...
	SElExceptionPtr (*GetBarCodeHousingStatus)(struct _SDBSStorage* me, const char* barCode, bool_t* tested, bool_t* failed);
	SElExceptionPtr (*GetBarCodeTopCoverStatus)(struct _SDBSStorage* me, const char* barCode, bool_t* tested, bool_t* failed);
