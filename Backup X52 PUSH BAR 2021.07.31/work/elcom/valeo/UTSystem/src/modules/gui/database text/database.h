...
#define  PARAM_BOUTTON_6                  6       /* control type: ring, callback function: OnVtype */
#define  PARAM_BOUTTON_5                  7       /* control type: ring, callback function: OnVtype */
#define  PARAM_BOUTTON_4                  8       /* control type: ring, callback function: OnVtype */
#define  PARAM_BOUTTON_3                  9       /* control type: ring, callback function: OnVtype */
#define  PARAM_BOUTTON_1                  10      /* control type: ring, callback function: OnVtype */
#define  PARAM_BOUTTON_2                  11      /* control type: ring, callback function: OnVtype */
#define  PARAM_VTYPE                      12      /* control type: ring, callback function: OnVtype */
#define  PARAM_TESTER                     13      /* control type: radioButton, callback function: (none) */
#define  PARAM_EXIT_OK                    14      /* control type: pictButton, callback function: (none) */
#define  PARAM_EXIT_CANCEL                15      /* control type: pictButton, callback function: (none) */
#define  PARAM_PICTURE_2                  16      /* control type: picture, callback function: (none) */
#define  PARAM_TEXTBOX                    17      /* control type: textBox, callback function: (none) */
#define  PARAM_PICTURE                    18      /* control type: picture, callback function: (none) */
