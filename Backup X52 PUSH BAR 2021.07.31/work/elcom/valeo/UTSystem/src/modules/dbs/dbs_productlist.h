...
typedef struct _SDBSProductList          
{
	...
	SElExceptionPtr (*ProductRename)(struct _SDBSProductList* me, int32_t branch_id, int32_t product_id, char* name); 
	...
	SElExceptionPtr (*ProductCheckRef)(struct _SDBSProductList* me,char  *ProductPartNumber, int *product_id);
