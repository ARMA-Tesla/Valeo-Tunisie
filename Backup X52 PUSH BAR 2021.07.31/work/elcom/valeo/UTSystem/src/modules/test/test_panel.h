...
#define TEST_GRAPH_STATION_50(data, sampsPerCan) \
	DeleteGraphPlot (gs_TestPanel, PANEL_GRAPH,-1, VAL_IMMEDIATE_DRAW); \
	SetAxisRange (gs_TestPanel, PANEL_GRAPH, VAL_MANUAL,getMinDoubleArray(data[MESS_WEG]), getMaxDoubleArray(data[MESS_WEG]), VAL_MANUAL,0, getMaxDoubleArray(data[MESS_KRAFT])); \
	PlotXY (gs_TestPanel,PANEL_GRAPH, &data[MESS_WEG], &data[MESS_KRAFT],sampsPerCan,VAL_DOUBLE,VAL_DOUBLE,VAL_THIN_LINE,VAL_EMPTY_SQUARE,VAL_SOLID,1,COLOR_FORCE); \
	PlotXY (gs_TestPanel,PANEL_GRAPH, &data[MESS_WEG], &data[MESS_CONTACT],sampsPerCan,VAL_DOUBLE,VAL_DOUBLE,VAL_THIN_LINE,VAL_EMPTY_SQUARE,VAL_SOLID,1,COLOR_CONTACT); \
	PlotXY (gs_TestPanel,PANEL_GRAPH, &data[MESS_WEG], &data[MESS_CONTACT2],sampsPerCan,VAL_DOUBLE,VAL_DOUBLE,VAL_THIN_LINE,VAL_EMPTY_SQUARE,VAL_SOLID,1,COLOR_CONTACT2); 

#define TEST_GRAPH_MESS_F1V_STATION_50(data, x, y, color) \
	double x_vect[2], y_vect[2]; \
	x_vect[0] = getMinDoubleArray(data[MESS_WEG]); \
	y_vect[0] = y; \
	x_vect[1] = x; \
	y_vect[1] = y; \
	PlotXY (gs_TestPanel,PANEL_GRAPH, x_vect, y_vect,2,VAL_DOUBLE,VAL_DOUBLE,VAL_THIN_LINE,VAL_EMPTY_SQUARE,VAL_SOLID,1,color); \
	x_vect[0] = x; \
...
#define TEST_GRAPH_MESS_F2V_STATION_50(data, x, y, color) \
	double x_vect2[2], y_vect2[2]; \
	x_vect2[0] = getMinDoubleArray(data[MESS_WEG]); \
	y_vect2[0] = y; \
	x_vect2[1] = x; \
	y_vect2[1] = y; \
	PlotXY (gs_TestPanel,PANEL_GRAPH, x_vect2, y_vect2,2,VAL_DOUBLE,VAL_DOUBLE,VAL_THIN_LINE,VAL_EMPTY_SQUARE,VAL_SOLID,1,color); \
	x_vect2[0] = x; \
	y_vect2[0] = getMinDoubleArray(data[MESS_KRAFT]); \
	x_vect2[1] = x; \
	y_vect2[1] = y; \
	PlotXY (gs_TestPanel,PANEL_GRAPH, x_vect2, y_vect2,2,VAL_DOUBLE,VAL_DOUBLE,VAL_THIN_LINE,VAL_EMPTY_SQUARE,VAL_SOLID,1,color); 

#define TEST_GRAPH_MESS_F1R_STATION_50(data, x, y, color) \
	double x_vect3[2], y_vect3[2]; \
	x_vect3[0] = getMinDoubleArray(data[MESS_WEG]); \
	y_vect3[0] = y; \
	x_vect3[1] = x; \
	y_vect3[1] = y; \
	PlotXY (gs_TestPanel,PANEL_GRAPH, x_vect3, y_vect3,2,VAL_DOUBLE,VAL_DOUBLE,VAL_THIN_LINE,VAL_EMPTY_SQUARE,VAL_SOLID,1,color); \
	x_vect3[0] = x; \
	y_vect3[0] = getMinDoubleArray(data[MESS_KRAFT]); \
	x_vect3[1] = x; \
	y_vect3[1] = y; \
	PlotXY (gs_TestPanel,PANEL_GRAPH, x_vect3, y_vect3,2,VAL_DOUBLE,VAL_DOUBLE,VAL_THIN_LINE,VAL_EMPTY_SQUARE,VAL_SOLID,1,color); 

#define TEST_GRAPH_MESS_F2R_STATION_50(data, x, y, color) \
	double x_vect4[2], y_vect4[2]; \
	x_vect4[0] = getMinDoubleArray(data[MESS_WEG]); \
	y_vect4[0] = y; \
	x_vect4[1] = x; \
	y_vect4[1] = y; \
	PlotXY (gs_TestPanel,PANEL_GRAPH, x_vect4, y_vect4,2,VAL_DOUBLE,VAL_DOUBLE,VAL_THIN_LINE,VAL_EMPTY_SQUARE,VAL_SOLID,1,color); \
	x_vect4[0] = x; \
	y_vect4[0] = getMinDoubleArray(data[MESS_KRAFT]); \
	x_vect4[1] = x; \
	y_vect4[1] = y; \
	PlotXY (gs_TestPanel,PANEL_GRAPH, x_vect4, y_vect4,2,VAL_DOUBLE,VAL_DOUBLE,VAL_THIN_LINE,VAL_EMPTY_SQUARE,VAL_SOLID,1,color); 


#define CONVERT_GRAPH_TO_PNG_STATION_50(path) \
	SaveGraphPNG (gs_TestPanel,PANEL_GRAPH, path); \

#define TEST_GRAPH_STATION_60(data, sampsPerCan) \
	DeleteGraphPlot (gs_TestPanel, PANEL_GRAPH_2,-1, VAL_IMMEDIATE_DRAW); \
	SetAxisRange (gs_TestPanel, PANEL_GRAPH_2, VAL_MANUAL,getMinDoubleArray(data[MESS_WEG]), getMaxDoubleArray(data[MESS_WEG]), VAL_MANUAL,0, getMaxDoubleArray(data[MESS_KRAFT])); \
	PlotXY (gs_TestPanel,PANEL_GRAPH_2, &data[MESS_WEG], &data[MESS_KRAFT],sampsPerCan,VAL_DOUBLE,VAL_DOUBLE,VAL_THIN_LINE,VAL_EMPTY_SQUARE,VAL_SOLID,1,COLOR_FORCE); \
	PlotXY (gs_TestPanel,PANEL_GRAPH_2, &data[MESS_WEG], &data[MESS_CONTACT],sampsPerCan,VAL_DOUBLE,VAL_DOUBLE,VAL_THIN_LINE,VAL_EMPTY_SQUARE,VAL_SOLID,1,COLOR_CONTACT); \
	PlotXY (gs_TestPanel,PANEL_GRAPH_2, &data[MESS_WEG], &data[MESS_CONTACT2],sampsPerCan,VAL_DOUBLE,VAL_DOUBLE,VAL_THIN_LINE,VAL_EMPTY_SQUARE,VAL_SOLID,1,COLOR_CONTACT2); 

#define TEST_GRAPH_MESS_F1V_STATION_60(data, x, y, color) \
	double x_vect10[2], y_vect10[2]; \
	x_vect10[0] = getMinDoubleArray2(data[MESS_WEG]); \
	y_vect10[0] = y; \
	x_vect10[1] = x; \
	y_vect10[1] = y; \
	PlotXY (gs_TestPanel,PANEL_GRAPH_2, x_vect10, y_vect10,2,VAL_DOUBLE,VAL_DOUBLE,VAL_THIN_LINE,VAL_EMPTY_SQUARE,VAL_SOLID,1,color); \
	x_vect10[0] = x; \
	y_vect10[0] = getMinDoubleArray2(data[MESS_KRAFT]); \
	x_vect10[1] = x; \
	y_vect10[1] = y; \
	PlotXY (gs_TestPanel,PANEL_GRAPH_2, x_vect10, y_vect10,2,VAL_DOUBLE,VAL_DOUBLE,VAL_THIN_LINE,VAL_EMPTY_SQUARE,VAL_SOLID,1,color); 


#define TEST_GRAPH_MESS_F2V_STATION_60(data, x, y, color) \
	double x_vect20[2], y_vect20[2]; \
	x_vect20[0] = getMinDoubleArray2(data[MESS_WEG]); \
	y_vect20[0] = y; \
	x_vect20[1] = x; \
	y_vect20[1] = y; \
	PlotXY (gs_TestPanel,PANEL_GRAPH_2, x_vect20, y_vect20,2,VAL_DOUBLE,VAL_DOUBLE,VAL_THIN_LINE,VAL_EMPTY_SQUARE,VAL_SOLID,1,color); \
	x_vect20[0] = x; \
	y_vect20[0] = getMinDoubleArray2(data[MESS_KRAFT]); \
	x_vect20[1] = x; \
	y_vect20[1] = y; \
	PlotXY (gs_TestPanel,PANEL_GRAPH_2, x_vect20, y_vect20,2,VAL_DOUBLE,VAL_DOUBLE,VAL_THIN_LINE,VAL_EMPTY_SQUARE,VAL_SOLID,1,color); 


#define TEST_GRAPH_MESS_F1R_STATION_60(data, x, y, color) \
	double x_vect30[2], y_vect30[2]; \
	x_vect30[0] = getMinDoubleArray2(data[MESS_WEG]); \
	y_vect30[0] = y; \
	x_vect30[1] = x; \
	y_vect30[1] = y; \
	PlotXY (gs_TestPanel,PANEL_GRAPH_2, x_vect30, y_vect30,2,VAL_DOUBLE,VAL_DOUBLE,VAL_THIN_LINE,VAL_EMPTY_SQUARE,VAL_SOLID,1,color); \
	x_vect30[0] = x; \
	y_vect30[0] = getMinDoubleArray2(data[MESS_KRAFT]); \
	x_vect30[1] = x; \
	y_vect30[1] = y; \
	PlotXY (gs_TestPanel,PANEL_GRAPH_2, x_vect30, y_vect30,2,VAL_DOUBLE,VAL_DOUBLE,VAL_THIN_LINE,VAL_EMPTY_SQUARE,VAL_SOLID,1,color); 


#define TEST_GRAPH_MESS_F2R_STATION_60(data, x, y, color) \
	double x_vect40[2], y_vect40[2]; \
	x_vect40[0] = getMinDoubleArray(data[MESS_WEG]); \
	y_vect40[0] = y; \
	x_vect40[1] = x; \
	y_vect40[1] = y; \
	PlotXY (gs_TestPanel,PANEL_GRAPH_2, x_vect40, y_vect40,2,VAL_DOUBLE,VAL_DOUBLE,VAL_THIN_LINE,VAL_EMPTY_SQUARE,VAL_SOLID,1,color); \
	x_vect40[0] = x; \
	y_vect40[0] = getMinDoubleArray(data[MESS_KRAFT]); \
	x_vect40[1] = x; \
	y_vect40[1] = y; \
	PlotXY (gs_TestPanel,PANEL_GRAPH_2, x_vect40, y_vect40,2,VAL_DOUBLE,VAL_DOUBLE,VAL_THIN_LINE,VAL_EMPTY_SQUARE,VAL_SOLID,1,color); 
...
#define CONVERT_GRAPH_TO_PNG_STATION_60(path) \
	SaveGraphPNG2 (gs_TestPanel,PANEL_GRAPH_2, path); \
