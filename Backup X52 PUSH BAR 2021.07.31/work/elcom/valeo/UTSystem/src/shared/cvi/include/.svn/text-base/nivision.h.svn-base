...
#define ERR_INVALID_KERNEL_SIZE_FOR_EDGE_DETECTION                   -1074396021 // Invalid kernel size for edge detection. The minimum kernel size is 3 and the kernel size must be odd.
...
#define ERR_BARCODE_PHARMACODE                                       -1074395875 // Pharmacode Error
...
#define ERR_INVALID_COLOR_SPECTRUM                                   -1074395311 // The color specturm array you provided does not contain enough elements or contains an element set to not-a-number (NaN).
...
IMAQ_FUNC int   __stdcall imaqGetWindowZoom2(int windowNumber, float* xZoom, float* yZoom);
...
IMAQ_FUNC int   __stdcall imaqZoomWindow2(int windowNumber, float xZoom, float yZoom, Point center);
