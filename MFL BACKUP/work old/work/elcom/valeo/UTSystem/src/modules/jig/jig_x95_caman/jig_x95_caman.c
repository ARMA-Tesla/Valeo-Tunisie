...
#undef __FUNC__
#define __FUNC__	"X95_CAMAN::Initialize"
...
)
{
	...
	EXCCHECKCOM( MSXML_IXMLDOMDocumentselectNodes (xml_doc, NULL,
						"//module[@id='"MODULE_JIG_X95_CAMAN"']/Sensors/Sensor",
						&sensors_list));
	...
	EXCCHECKCOM( MSXML_IXMLDOMDocumentselectNodes (xml_doc, NULL,
						"//module[@id='"MODULE_JIG_X95_CAMAN"']/BarCodeReaders/BarCodeReader",
						&bcr_list));
	if (bcr_list)
	{
...
#undef __FUNC__
#define __FUNC__	"X95_CAMAN::Destroy"
...
#undef __FUNC__
#define __FUNC__	"X95_CAMAN::GetUUID"
SElExceptionPtr GetUUID(struct _SJig* me, char* uuid, uint32_t size)
{
	SElExceptionPtr	pexception = NULL;
	
	strncpy(uuid, MODULE_JIG_X95_CAMAN, size);
...
/* Lock product */
#undef __FUNC__
#define __FUNC__	"X95_CAMAN::LockItem"
...
/* Unlock product */
#undef __FUNC__
#define __FUNC__	"X95_CAMAN::UnlockItem"
...
#undef __FUNC__
#define __FUNC__	"X95_CAMAN::ConnectToItem"
...
)
{
	...
	if (timeout)
	{
		if(gs_connectorsUp && !gs_connectorsDown) goto Error;		
		if (WaitForSingleObject( hevent, timeout) == WAIT_TIMEOUT)
		{
			if(gs_connectorsUp && !gs_connectorsDown) goto Error;
			EXCTHROW( JIG_ERROR_TIMEOUT, "Function Timeouted");
...
#undef __FUNC__
#define __FUNC__	"X95_CAMAN::DisconnectFromItem"
...
/* Connectors disconnect from product */
#undef __FUNC__
#define __FUNC__	"X95_CAMAN::ColdMarking"
...
#undef __FUNC__
#define __FUNC__	"X95_CAMAN::SetItemPosition"
...
/* Get JIG position */
#undef __FUNC__
#define __FUNC__	"X95_CAMAN::GetItemPosition"
...
#undef __FUNC__
#define __FUNC__	"X95_CAMAN::GetItemCode"
...
#undef __FUNC__
#define __FUNC__	"X95_CAMAN::GetSensor"
...
#undef __FUNC__
#define __FUNC__	"X95_CAMAN::SetSensor"
...
/* Get Attribute Int32 */
#undef __FUNC__
#define __FUNC__	"X95_CAMAN::GetAttributeInt32"
...
/* Set Attribute Int32 */
#undef __FUNC__
#define __FUNC__	"X95_CAMAN::SetAttributeInt32"
...
#undef __FUNC__
#define __FUNC__	"X95_CAMAN::GetAttributeBoolean"
...
#undef __FUNC__
#define __FUNC__	"X95_CAMAN::SetAttributeBoolean"
...
#undef __FUNC__
#define __FUNC__	"X95_CAMAN::JigThread"
