...
SElExceptionPtr	_FUNCC InitializeElcomModule( void* pInstance, const char* configuration, SPluginArgsPtr pParam)
{
	...
	if ( gs_EventFactory )
	{
		...
		EXCCHECK( gs_EventFactory->RegisterEvent(gs_EventFactory, EVNT_JIG_ITEM_START_RODAGE_STATION_20));
		EXCCHECK( gs_EventFactory->RegisterEvent(gs_EventFactory, EVNT_JIG_ITEM_STOP_RODAGE_STATION_20));	
		...
		EXCCHECK( gs_EventFactory->RegisterEvent(gs_EventFactory, EVNT_JIG_ITEM_START_RODAGE_LEFT_STATION_50));
		EXCCHECK( gs_EventFactory->RegisterEvent(gs_EventFactory, EVNT_JIG_ITEM_STOP_RODAGE_LEFT_STATION_50));
		EXCCHECK( gs_EventFactory->RegisterEvent(gs_EventFactory, EVNT_JIG_ITEM_START_RODAGE_RIGHT_STATION_50));
		EXCCHECK( gs_EventFactory->RegisterEvent(gs_EventFactory, EVNT_JIG_ITEM_STOP_RODAGE_RIGHT_STATION_50));
		
		EXCCHECK( gs_EventFactory->RegisterEvent(gs_EventFactory, EVNT_JIG_ITEM_PLUGGED_STATION_60));
		EXCCHECK( gs_EventFactory->RegisterEvent(gs_EventFactory, EVNT_JIG_ITEM_UNPLUGGED_STATION_60));
		EXCCHECK( gs_EventFactory->RegisterEvent(gs_EventFactory, EVNT_JIG_ITEM_START_TEST_LEFT_STATION_60));
		EXCCHECK( gs_EventFactory->RegisterEvent(gs_EventFactory, EVNT_JIG_ITEM_STOP_TEST_LEFT_STATION_60));
		EXCCHECK( gs_EventFactory->RegisterEvent(gs_EventFactory, EVNT_JIG_ITEM_START_TEST_RIGHT_STATION_60));
		EXCCHECK( gs_EventFactory->RegisterEvent(gs_EventFactory, EVNT_JIG_ITEM_STOP_TEST_RIGHT_STATION_60));
		
		EXCCHECK( gs_EventFactory->RegisterEvent(gs_EventFactory, EVNT_JIG_ITEM_PLUGGED_STATION_70));
		EXCCHECK( gs_EventFactory->RegisterEvent(gs_EventFactory, EVNT_JIG_ITEM_UNPLUGGED_STATION_70));
		...
		EXCCHECK( gs_EventFactory->RegisterEvent(gs_EventFactory, EVNT_LASER_CYCLE_END));
