...
#define COLD_MARKING_TIME_UP				100
...
#undef __FUNC__
#define __FUNC__	"E89_IHKA::Initialize"
...
)
{
	...
	EXCCHECKCOM( MSXML_IXMLDOMDocumentselectNodes (xml_doc, NULL,
						"//module[@id='"MODULE_JIG_E89_IHKA"']/Sensors/Sensor",
						&sensors_list));
	...
	EXCCHECKCOM( MSXML_IXMLDOMDocumentselectNodes (xml_doc, NULL,
						"//module[@id='"MODULE_JIG_E89_IHKA"']/BarCodeReaders/BarCodeReader",
						&bcr_list));
	if (bcr_list)
	{
...
#undef __FUNC__
#define __FUNC__	"E89_IHKA::Destroy"
...
#undef __FUNC__
#define __FUNC__	"E89_IHKA::GetUUID"
SElExceptionPtr GetUUID(struct _SJig* me, char* uuid, uint32_t size)
{
	SElExceptionPtr	pexception = NULL;
	
	strncpy(uuid, MODULE_JIG_E89_IHKA, size);
...
/* Lock product */
#undef __FUNC__
#define __FUNC__	"E89_IHKA::LockItem"
...
/* Unlock product */
#undef __FUNC__
#define __FUNC__	"E89_IHKA::UnlockItem"
...
#undef __FUNC__
#define __FUNC__	"E89_IHKA::ConnectToItem"
...
#undef __FUNC__
#define __FUNC__	"E89_IHKA::DisconnectFromItem"
...
/* Connectors disconnect from product */
#undef __FUNC__
#define __FUNC__	"E89_IHKA::ColdMarking"
...
#undef __FUNC__
#define __FUNC__	"E89_IHKA::SetItemPosition"
...
/* Get JIG position */
#undef __FUNC__
#define __FUNC__	"E89_IHKA::GetItemPosition"
...
#undef __FUNC__
#define __FUNC__	"E89_IHKA::GetItemCode"
...
)
{
	...
	if (me->pBarCodeReader->reader)
	{
		...
		else
		{
			...
			if (index > 20)
					EXCTHROW(JIG_ERROR_INVALID_PARAMETER, "Invalid Barcode Index");

			sprintf(cmd, "LON%d", index);
			EXCCHECK((me->pBarCodeReader->reader)->WriteData((me->pBarCodeReader->reader), cmd));
		}
...
#undef __FUNC__
#define __FUNC__	"E89_IHKA::GetSensor"
...
#undef __FUNC__
#define __FUNC__	"E89_IHKA::SetSensor"
...
/* Get Attribute Int32 */
#undef __FUNC__
#define __FUNC__	"E89_IHKA::GetAttributeInt32"
...
/* Set Attribute Int32 */
#undef __FUNC__
#define __FUNC__	"E89_IHKA::SetAttributeInt32"
...
#undef __FUNC__
#define __FUNC__	"E89_IHKA::GetAttributeBoolean"
...
#undef __FUNC__
#define __FUNC__	"E89_IHKA::SetAttributeBoolean"
...
#undef __FUNC__
#define __FUNC__	"E89_IHKA::JigThread"
...
)
{
	...
	EXCCHECK( me->jig_GetSensor(me, "IsPanelLock_Middle_Up", &lock3));
	EXCCHECK( me->jig_GetSensor(me, "IsPanelLock_Middle_Down", &lock4));
	EXCCHECK( me->jig_GetSensor(me, "IsPanelLock_Right_Up", &lock5));
	EXCCHECK( me->jig_GetSensor(me, "IsPanelLock_Right_Down", &lock6));
	...
	EXCCHECK( me->jig_GetSensor(me, "IsPanelUnlock_Middle_Up", &lock3));
	EXCCHECK( me->jig_GetSensor(me, "IsPanelUnlock_Middle_Down", &lock4));
	EXCCHECK( me->jig_GetSensor(me, "IsPanelUnlock_Right_Up", &lock5));
	EXCCHECK( me->jig_GetSensor(me, "IsPanelUnlock_Right_Down", &lock6));
	if (lock1 && lock2 && lock3 && lock4 && lock5 && lock6)
	{
