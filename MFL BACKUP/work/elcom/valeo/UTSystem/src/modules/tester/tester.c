...
static SElExceptionPtr TableRotate(struct _STester* me, int32_t timeout, bool_t wait_end)
{
	...
	bool_t			is_z_home_right_station_30,
			...
			/* STATION 30 */
			EXCCHECK( me->axissAPI->GetaxisByIndex(me->axissAPI, SYSTEM_AXIS_STATION_30_RIGHT+6, &paxis));
			EXCCHECK( paxis->CurrentPosition(paxis, AXIS_Z, &position_axis_Z_right_station_30));
			EXCCHECK( me->axissAPI->GetaxisByIndex(me->axissAPI, SYSTEM_AXIS_STATION_30_LEFT+6, &paxis));
			...
			/* STATION 40 */
			EXCCHECK( me->axissAPI->GetaxisByIndex(me->axissAPI, SYSTEM_AXIS_STATION_40_RIGHT+6, &paxis));
			EXCCHECK( paxis->CurrentPosition(paxis, AXIS_Z, &position_axis_Z_right_station_40));
			EXCCHECK( me->axissAPI->GetaxisByIndex(me->axissAPI, SYSTEM_AXIS_STATION_40_LEFT+6, &paxis));
...
)
{
	...
	case STATION_30 :
	me->axissAPI->GetaxisByIndex(me->axissAPI, SYSTEM_AXIS_STATION_30_RIGHT+6, &paxis);
	paxis->EnableAxis(paxis, AXIS_Z); 
	paxis->SetPosition(paxis, AXIS_Z, 0.0, 100.0);
	paxis->SetPosition(paxis, AXIS_Z, 0.0, 100.0);
	paxis->EnableAxis(paxis, AXIS_Z); 
	me->axissAPI->GetaxisByIndex(me->axissAPI, SYSTEM_AXIS_STATION_30_LEFT+6, &paxis);
	paxis->EnableAxis(paxis, AXIS_Z); 
	paxis->SetPosition(paxis, AXIS_Z, 0.0, 100.0);
	paxis->SetPosition(paxis, AXIS_Z, 0.0, 100.0);
	paxis->EnableAxis(paxis, AXIS_Z); 
	...
	case STATION_40 :
	me->axissAPI->GetaxisByIndex(me->axissAPI, SYSTEM_AXIS_STATION_40_RIGHT+6, &paxis);
	paxis->EnableAxis(paxis, AXIS_Z); 
	paxis->SetPosition(paxis, AXIS_Z, 0.0, 100.0);
	paxis->SetPosition(paxis, AXIS_Z, 0.0, 100.0);
	paxis->EnableAxis(paxis, AXIS_Z); 
	me->axissAPI->GetaxisByIndex(me->axissAPI, SYSTEM_AXIS_STATION_40_LEFT+6, &paxis);
	paxis->EnableAxis(paxis, AXIS_Z); 
	paxis->SetPosition(paxis, AXIS_Z, 0.0, 100.0);
	paxis->SetPosition(paxis, AXIS_Z, 0.0, 100.0);
	paxis->EnableAxis(paxis, AXIS_Z); 
