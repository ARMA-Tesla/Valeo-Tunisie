...
#define AXIS_MOVE_PUSH_PHONE_STATION_30(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_30_RIGHT], ptester, check, 21.0, 9.0, 6.0, "PEND_Z_RIGHT_STATION_30", "PEND_Y_RIGHT_STATION_30", "PEND_X_RIGHT_STATION_30"));//OK

#define AXIS_MOVE_PUSH_LIST_STATION_30(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_30_RIGHT], ptester, check, 21.3, 11.0, 25.0, "PEND_Z_RIGHT_STATION_30", "PEND_Y_RIGHT_STATION_30", "PEND_X_RIGHT_STATION_30"));//OK

#define AXIS_MOVE_PUSH_SPEECH_STATION_30(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_30_RIGHT], ptester, check, 21.8, 13.5, 42.0, "PEND_Z_RIGHT_STATION_30", "PEND_Y_RIGHT_STATION_30", "PEND_X_RIGHT_STATION_30"));

#define AXIS_MOVE_PUSH_MENU_RIGHT_STATION_30(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_30_RIGHT], ptester, check, 22.7, 25.0, 44.0, "PEND_Z_RIGHT_STATION_30", "PEND_Y_RIGHT_STATION_30", "PEND_X_RIGHT_STATION_30"));

#define AXIS_MOVE_PUSH_SCROLL_WHEEL_STATION_30(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_30_RIGHT], ptester, check, 23.7, 24.0, 27.0, "PEND_Z_RIGHT_STATION_30", "PEND_Y_RIGHT_STATION_30", "PEND_X_RIGHT_STATION_30"));

#define AXIS_MOVE_PUSH_MENU_LEFT_STATION_30(check) \
   	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_30_RIGHT], ptester, check, 23.7, 25.0, 8.0, "PEND_Z_RIGHT_STATION_30", "PEND_Y_RIGHT_STATION_30", "PEND_X_RIGHT_STATION_30"));

#define AXIS_MOVE_PUSH_VOLUME_MINUS_STATION_30(check) \
  	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_30_RIGHT], ptester, check, 24.0, 41.0, 13.0, "PEND_Z_RIGHT_STATION_30", "PEND_Y_RIGHT_STATION_30", "PEND_X_RIGHT_STATION_30"));

#define AXIS_MOVE_PUSH_VOLUME_PLUS_STATION_30(check) \
   	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_30_RIGHT], ptester, check, 22.0, 37.0, 43.0, "PEND_Z_RIGHT_STATION_30", "PEND_Y_RIGHT_STATION_30", "PEND_X_RIGHT_STATION_30"));
/*------------------------------------------------------------------------------------------------------*/ 

/*------------------------  Positions Left pushs STATION 30 : OK ---------------------------------------*/
#define AXIS_MOVE_PUSH_WHEEL_STATION_30(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_30_LEFT], ptester, check, 21.0, 8.0, 7.0, "PEND_Z_LEFT_STATION_30", "PEND_Y_LEFT_STATION_30", "PEND_X_LEFT_STATION_30"));

#define AXIS_MOVE_PUSH_SPEED_STATION_30(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_30_LEFT], ptester, check, 21.6, 10.5, 26.0, "PEND_Z_LEFT_STATION_30", "PEND_Y_LEFT_STATION_30", "PEND_X_LEFT_STATION_30"));

#define AXIS_MOVE_PUSH_SET_STATION_30(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_30_LEFT], ptester, check, 22.0, 13.5, 43.0, "PEND_Z_LEFT_STATION_30", "PEND_Y_LEFT_STATION_30", "PEND_X_LEFT_STATION_30"));

#define AXIS_MOVE_PUSH_MINUS_STATION_30(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_30_LEFT], ptester, check, 23.2, 25.0, 44.0, "PEND_Z_LEFT_STATION_30", "PEND_Y_LEFT_STATION_30", "PEND_X_LEFT_STATION_30"));

#define AXIS_MOVE_PUSH_PLUS_STATION_30(check) \
   	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_30_LEFT], ptester, check, 24.0, 25.0, 8.0, "PEND_Z_LEFT_STATION_30", "PEND_Y_LEFT_STATION_30", "PEND_X_LEFT_STATION_30")); //

#define AXIS_MOVE_PUSH_CANCEL_STATION_30(check) \
  	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_30_LEFT], ptester, check, 24.0, 41.0, 13.0, "PEND_Z_LEFT_STATION_30", "PEND_Y_LEFT_STATION_30", "PEND_X_LEFT_STATION_30"));

#define AXIS_MOVE_PUSH_RESUME_STATION_30(check) \
   	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_30_LEFT], ptester, check, 24.0, 37.0, 43.0, "PEND_Z_LEFT_STATION_30", "PEND_Y_LEFT_STATION_30", "PEND_X_LEFT_STATION_30"));
/*------------------------------------------------------------------------------------------------------*/ 

/* Home system axis station 30 */
#define AXIS_HOME_ALL_STATION_30(check) \
	MoveAxis2(paxis[SYSTEM_AXIS_STATION_30_RIGHT], AXIS_Z,0.0, 100.0); \
	MoveAxis2(paxis[SYSTEM_AXIS_STATION_30_LEFT], AXIS_Z,0.0, 100.0);  
...
#define AXIS_Z_UP_STATION_30(check) \
	...
	EXCCHECK( paxis[SYSTEM_AXIS_STATION_30_RIGHT]->CurrentPosition(paxis[SYSTEM_AXIS_STATION_30_RIGHT], AXIS_Z, &position_z)); \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_30_RIGHT], ptester, check, position_z - 4.0, position_y, position_x, "PEND_Z_RIGHT_STATION_30", "PEND_Y_RIGHT_STATION_30", "PEND_X_RIGHT_STATION_30"));


/*------------------------  Positions Right pushs STATION 40 : OK ----------------------------------------------*/
#define AXIS_MOVE_PUSH_PHONE_STATION_40(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_40_RIGHT], ptester, check, 22.0, 8.0, 6.0, "PEND_Z_RIGHT_STATION_40", "PEND_Y_RIGHT_STATION_40", "PEND_X_RIGHT_STATION_40"));//OK

#define AXIS_MOVE_PUSH_LIST_STATION_40(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_40_RIGHT], ptester, check, 22.0, 10.0, 25.0, "PEND_Z_RIGHT_STATION_40", "PEND_Y_RIGHT_STATION_40", "PEND_X_RIGHT_STATION_40"));//OK

#define AXIS_MOVE_PUSH_SPEECH_STATION_40(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_40_RIGHT], ptester, check, 22.0, 12.0, 42.0, "PEND_Z_RIGHT_STATION_40", "PEND_Y_RIGHT_STATION_40", "PEND_X_RIGHT_STATION_40"));

#define AXIS_MOVE_PUSH_MENU_RIGHT_STATION_40(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_40_RIGHT], ptester, check, 22.0, 25.0, 46.0, "PEND_Z_RIGHT_STATION_40", "PEND_Y_RIGHT_STATION_40", "PEND_X_RIGHT_STATION_40"));

#define AXIS_MOVE_PUSH_SCROLL_WHEEL_STATION_40(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_40_RIGHT], ptester, check, 21.0, 11.2, 21.0, "PEND_Z_RIGHT_STATION_40", "PEND_Y_RIGHT_STATION_40", "PEND_X_RIGHT_STATION_40"));

#define AXIS_MOVE_PUSH_MENU_LEFT_STATION_40(check) \
   	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_40_RIGHT], ptester, check, 23.0, 10.7, 40.7, "PEND_Z_RIGHT_STATION_40", "PEND_Y_RIGHT_STATION_40", "PEND_X_RIGHT_STATION_40"));

#define AXIS_MOVE_PUSH_VOLUME_MINUS_STATION_40(check) \
  	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_40_RIGHT], ptester, check, 24.5, 3.0, 33.5, "PEND_Z_RIGHT_STATION_40", "PEND_Y_RIGHT_STATION_40", "PEND_X_RIGHT_STATION_40"));

#define AXIS_MOVE_PUSH_VOLUME_PLUS_STATION_40(check) \
   	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_40_RIGHT], ptester, check, 24.0, 4.5, 11.0, "PEND_Z_RIGHT_STATION_40", "PEND_Y_RIGHT_STATION_40", "PEND_X_RIGHT_STATION_40"));
/*------------------------------------------------------------------------------------------------------*/ 

/*------------------------  Positions Left pushs STATION 40 : OK----------------------------------------------*/
#define AXIS_MOVE_PUSH_WHEEL_STATION_40(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_40_LEFT], ptester, check, 21.0, 8.0, 6.0, "PEND_Z_LEFT_STATION_40", "PEND_Y_LEFT_STATION_40", "PEND_X_LEFT_STATION_40"));

#define AXIS_MOVE_PUSH_SPEED_STATION_40(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_40_LEFT], ptester, check, 21.0, 10.0, 25.0, "PEND_Z_LEFT_STATION_40", "PEND_Y_LEFT_STATION_40", "PEND_X_LEFT_STATION_40"));

#define AXIS_MOVE_PUSH_SET_STATION_40(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_40_LEFT], ptester, check, 21.0, 12.0, 42.0, "PEND_Z_LEFT_STATION_40", "PEND_Y_LEFT_STATION_40", "PEND_X_LEFT_STATION_40"));

#define AXIS_MOVE_PUSH_MINUS_STATION_40(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_40_LEFT], ptester, check, 22.0, 24.0, 44.0, "PEND_Z_LEFT_STATION_40", "PEND_Y_LEFT_STATION_40", "PEND_X_LEFT_STATION_40"));

#define AXIS_MOVE_PUSH_PLUS_STATION_40(check) \
   	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_40_LEFT], ptester, check, 23.6, 24.5, 40.0, "PEND_Z_LEFT_STATION_40", "PEND_Y_LEFT_STATION_40", "PEND_X_LEFT_STATION_40")); //

#define AXIS_MOVE_PUSH_CANCEL_STATION_40(check) \
  	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_40_LEFT], ptester, check, 25.2, 10.0, 32.5, "PEND_Z_LEFT_STATION_40", "PEND_Y_LEFT_STATION_40", "PEND_X_LEFT_STATION_40"));

#define AXIS_MOVE_PUSH_RESUME_STATION_40(check) \
   	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_40_LEFT], ptester, check, 24.5, 12.5, 11.5, "PEND_Z_LEFT_STATION_40", "PEND_Y_LEFT_STATION_40", "PEND_X_LEFT_STATION_40"));
/*------------------------------------------------------------------------------------------------------*/ 

/* Home system axis station 30 */
#define AXIS_HOME_ALL_STATION_40(check) \
	MoveAxis2(paxis[SYSTEM_AXIS_STATION_40_RIGHT], AXIS_Z,0.0, 100.0); \
	MoveAxis2(paxis[SYSTEM_AXIS_STATION_40_LEFT], AXIS_Z,0.0, 100.0);
...
#define AXIS_Z_UP_STATION_40(check) \
	...
	EXCCHECK( paxis[SYSTEM_AXIS_STATION_40_RIGHT]->CurrentPosition(paxis[SYSTEM_AXIS_STATION_40_RIGHT], AXIS_Z, &position_z)); \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_STATION_40_RIGHT], ptester, check, position_z - 4.0, position_y, position_x, "PEND_Z_RIGHT_STATION_40", "PEND_Y_RIGHT_STATION_40", "PEND_X_RIGHT_STATION_40"));
...
#define TEST_END_STATION(istation) \
	...
	TEST_DURATION((double)(clock()-_start_test_clock)/(double)CLOCKS_PER_SEC); \
 	if(pexception && ((STestParamPtr)pTID)->fault_continue == FALSE) { StopThreads(istation); \
