...
typedef struct _axis
{
	...
	SElExceptionPtr (*CurrentAnalog)(struct _axis* me, int32_t axis, double *analog, double Coefficient, double Offsets);
	...
	SElExceptionPtr (*_CurrentAnalogSpec)(struct _axis* me, int32_t axis, double* analog, double Coefficient, double Offsets);
