...
)
{
	...
	//	printf ("END COGNEX GET CAMERA BY INDEX : time = %f\r\n", time); 
	//	_start_test_clock =  clock();   
		EXCCHECK( pcamera->Cognex_disconnect(pcamera));
	//	time = (double)(clock()-_start_test_clock);
	//	printf ("END COGNEX DISCONNECT : time = %f\r\n", time);
	//	_start_test_clock =  clock();
		EXCCHECK( pcamera->openTCPserver(pcamera));
	//	time = (double)(clock()-_start_test_clock);
	//	printf ("END COGNEX OPEN TCP SERVER : time = %f\r\n", time); 
	//	_start_test_clock =  clock();
		EXCCHECK( pcamera->Cognex_login(pcamera));
	//	time = (double)(clock()-_start_test_clock);
	//	printf ("END COGNEX LOGIN : time = %f\r\n", time);
	//	_start_test_clock =  clock();
		EXCCHECK( pcamera->Cognex_set_param(pcamera, step));
		Sleep(150);
	//	time = (double)(clock()-_start_test_clock);
	//	printf ("END COGNEX SET PARAM : time = %f\r\n", time);
	//	_start_test_clock =  clock();
		EXCCHECK( pcamera->Cognex_Trigger(pcamera));
	    Sleep(250);
		time = (double)(clock()-_start_test_clock);
	//	printf ("END COGNEX Trigger : time = %f\r\n", time);
...
//		printf ("END COGNEX READ : time = %f\r\n", time);
		...
		EXCCHECK( pcamera->Cognex_disconnect(pcamera));
		time = (double)(clock()-_start_test_clock);
//		printf ("END COGNEX DISCONNECT 2 : time = %f\r\n", time);
		EXCCHECK( pcamera->openTCPserver(pcamera));	
		time = (double)(clock()-_start_test_clock);
//		printf ("END COGNEX OPEN TCP SERVER 2 : time = %f\r\n", time);
		EXCCHECK( pcamera->Cognex_login(pcamera));
		time = (double)(clock()-_start_test_clock);
//		printf ("END COGNEX LOGIN 2 : time = %f\r\n", time);
		EXCCHECK( pcamera->Cognex_set_param(pcamera, step));
		Sleep(150);
		time = (double)(clock()-_start_test_clock);
//		printf ("END COGNEX SET PARAM 2 : time = %f\r\n", time);
		EXCCHECK( pcamera->Cognex_Trigger(pcamera));
	    Sleep(250);
		time = (double)(clock()-_start_test_clock);
	//	printf ("END COGNEX TRIGGER 2 : time = %f\r\n", time);
		}
