...
#define RIGHT_MID_RIGHT_OFFSET_F1     0.88  //0.88
					...
					for (j=0; j<2; j++)
						{
							...
							sprintf (MAN_DATA_1_Revision_Index_Read[station], "%02X", data[station][5]);
							...
							sprintf (MAN_DATA_1_Production_Batch_Number[station], "%02X", data[station][6]);
