...
#define TEST_GRAPH2_RIGHT_STATION_30(name, data, sampsPerCan) \
	...
	PlotXY (gs_TestPanel2,PANEL_2_GRAPH, &data[MESS_WEG], &data[MESS_KRAFT],sampsPerCan,VAL_DOUBLE,VAL_DOUBLE,VAL_THIN_LINE,VAL_EMPTY_SQUARE,VAL_SOLID,1,VAL_RED); \

#define TEST_GRAPH2_LEFT_STATION_30(name, data, sampsPerCan) \
	...
	PlotXY (gs_TestPanel2,PANEL_2_GRAPH_2, &data[MESS_WEG], &data[MESS_KRAFT],sampsPerCan,VAL_DOUBLE,VAL_DOUBLE,VAL_THIN_LINE,VAL_EMPTY_SQUARE,VAL_SOLID,1,VAL_RED); \
...
#define TEST_GRAPH2_RIGHT_STATION_40(name, data, sampsPerCan) \
	...
	PlotXY (gs_TestPanel3,PANEL_3_GRAPH, &data[MESS_WEG], &data[MESS_KRAFT],sampsPerCan,VAL_DOUBLE,VAL_DOUBLE,VAL_THIN_LINE,VAL_EMPTY_SQUARE,VAL_SOLID,1,VAL_RED); \

#define TEST_GRAPH2_LEFT_STATION_40(name, data, sampsPerCan) \
	...
	PlotXY (gs_TestPanel3,PANEL_3_GRAPH_2, &data[MESS_WEG], &data[MESS_KRAFT],sampsPerCan,VAL_DOUBLE,VAL_DOUBLE,VAL_THIN_LINE,VAL_EMPTY_SQUARE,VAL_SOLID,1,VAL_RED); \
