...
#define SYSTEM_AXIS_Z_STATION_30_RIGHT  6
#define SYSTEM_AXIS_Z_STATION_30_LEFT  	7
#define SYSTEM_AXIS_Z_STATION_40_RIGHT  8
#define SYSTEM_AXIS_Z_STATION_40_LEFT  	9
...
//------------------------  Positions Right pushs STATION 30 : OK --------------------------------------
#define AXIS_MOVE_PUSH_PHONE_STATION_30(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_Z_STATION_30_RIGHT], paxis[SYSTEM_AXIS_STATION_30_RIGHT], ptester, check, 41.5, 39.5, 42.2));//OK

#define AXIS_MOVE_PUSH_LIST_STATION_30(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_Z_STATION_30_RIGHT], paxis[SYSTEM_AXIS_STATION_30_RIGHT], ptester, check, 42.0, 37.4, 22.5));//OK

#define AXIS_MOVE_PUSH_SPEECH_STATION_30(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_Z_STATION_30_RIGHT], paxis[SYSTEM_AXIS_STATION_30_RIGHT], ptester, check, 42.0, 35.0, 6.5));

#define AXIS_MOVE_PUSH_MENU_RIGHT_STATION_30(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_Z_STATION_30_RIGHT], paxis[SYSTEM_AXIS_STATION_30_RIGHT], ptester, check, 43.5, 23.0, 5.5));

//------------------------  Positions Left pushs STATION 30 : OK --------------------------------------
#define AXIS_MOVE_PUSH_WHEEL_STATION_30(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_Z_STATION_30_LEFT], paxis[SYSTEM_AXIS_STATION_30_LEFT], ptester, check, 41.5, 7.61, 44.49));

#define AXIS_MOVE_PUSH_SPEED_STATION_30(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_Z_STATION_30_LEFT], paxis[SYSTEM_AXIS_STATION_30_LEFT], ptester, check, 41.0, 10.02, 25.59));

#define AXIS_MOVE_PUSH_SET_STATION_30(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_Z_STATION_30_LEFT], paxis[SYSTEM_AXIS_STATION_30_LEFT], ptester, check, 41.5, 13.0, 7.8));

#define AXIS_MOVE_PUSH_MINUS_STATION_30(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_Z_STATION_30_LEFT], paxis[SYSTEM_AXIS_STATION_30_LEFT], ptester, check, 42.5, 24.51, 6.7));


//------------------------  Positions Right pushs STATION 40 : OK --------------------------------------
#define AXIS_MOVE_PUSH_SCROLL_WHEEL_STATION_40(check) \
	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_Z_STATION_40_RIGHT],paxis[SYSTEM_AXIS_STATION_40_RIGHT], ptester, check, 41.5, 22.0, 19.9));   //old y-3

#define AXIS_MOVE_PUSH_MENU_LEFT_STATION_40(check) \
   	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_Z_STATION_40_RIGHT],paxis[SYSTEM_AXIS_STATION_40_RIGHT], ptester, check, 43.5, 22.0, 40.0));  //old y-3	 //old x=39

#define AXIS_MOVE_PUSH_VOLUME_MINUS_STATION_40(check) \
  	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_Z_STATION_40_RIGHT],paxis[SYSTEM_AXIS_STATION_40_RIGHT], ptester, check, 44.5, 6.0, 35.0));   //old y-3   // old x=32

#define AXIS_MOVE_PUSH_VOLUME_PLUS_STATION_40(check) \
   	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_Z_STATION_40_RIGHT],paxis[SYSTEM_AXIS_STATION_40_RIGHT], ptester, check, 44.5,9.3,10.0));		 //old y-3

//------------------------  Positions Left pushs STATION 40 : OK----------------------------------------
#define AXIS_MOVE_PUSH_PLUS_STATION_40(check) \
   	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_Z_STATION_40_LEFT],paxis[SYSTEM_AXIS_STATION_40_LEFT], ptester, check, 43.0, 24.8, 9.0)); 

#define AXIS_MOVE_PUSH_CANCEL_STATION_40(check) \
  	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_Z_STATION_40_LEFT],paxis[SYSTEM_AXIS_STATION_40_LEFT], ptester, check, 44.0, 10.82, 15.2));  // old Z=44.5

#define AXIS_MOVE_PUSH_RESUME_STATION_40(check) \
   	EXCCHECK( MoveToPush(paxis[SYSTEM_AXIS_Z_STATION_40_LEFT],paxis[SYSTEM_AXIS_STATION_40_LEFT], ptester, check, 43.5, 12.9, 36));   // old Z=44
...
FCE_TEST(MFL, 30_04)
{
	...
	INITIALIZE_AXIS(SYSTEM_AXIS_Z_STATION_30_RIGHT);
	INITIALIZE_AXIS(SYSTEM_AXIS_Z_STATION_30_LEFT);
...
FCE_TEST(MFL, 30_40)
{
	...
	paxis[SYSTEM_AXIS_Z_STATION_30_RIGHT]->CurrentPosition(paxis[SYSTEM_AXIS_Z_STATION_30_RIGHT], AXIS_Z, &Last_position[SYSTEM_AXIS_Z_STATION_30_RIGHT]);//Right
	paxis[SYSTEM_AXIS_Z_STATION_30_LEFT]->CurrentPosition(paxis[SYSTEM_AXIS_Z_STATION_30_LEFT], AXIS_Z, &Last_position[SYSTEM_AXIS_Z_STATION_30_LEFT]); //Left
	...
	for (i=0; i<2; i++)
	{
		...
		pthread_data[i]->paxis = paxis[i+6];
...
Error:
	...
	else if (pexception && ((STestParamPtr)pTID)->fault_retest == TRUE)
	{
		...
		paxis[SYSTEM_AXIS_Z_STATION_30_RIGHT]->SetPosition(paxis[SYSTEM_AXIS_Z_STATION_30_RIGHT], AXIS_Z, Last_position[SYSTEM_AXIS_Z_STATION_30_RIGHT], 100.0); //Right
		paxis[SYSTEM_AXIS_Z_STATION_30_RIGHT]->EnableAxis(paxis[SYSTEM_AXIS_Z_STATION_30_RIGHT], AXIS_Z);
								
		paxis[SYSTEM_AXIS_Z_STATION_30_LEFT]->SetPosition(paxis[SYSTEM_AXIS_Z_STATION_30_LEFT], AXIS_Z, Last_position[SYSTEM_AXIS_Z_STATION_30_LEFT], 100.0); //LEFT
		paxis[SYSTEM_AXIS_Z_STATION_30_LEFT]->EnableAxis(paxis[SYSTEM_AXIS_Z_STATION_30_LEFT], AXIS_Z);
	}
...
FCE_TEST(MFL, 40_04)
{
	...
	INITIALIZE_AXIS(SYSTEM_AXIS_Z_STATION_40_RIGHT);
	INITIALIZE_AXIS(SYSTEM_AXIS_Z_STATION_40_LEFT);
...
FCE_TEST(MFL, 40_40)				  
{
	...
	paxis[SYSTEM_AXIS_Z_STATION_40_RIGHT]->CurrentPosition(paxis[SYSTEM_AXIS_Z_STATION_40_RIGHT], AXIS_Z, &Last_position[SYSTEM_AXIS_Z_STATION_40_RIGHT]);//Right
	paxis[SYSTEM_AXIS_Z_STATION_40_LEFT]->CurrentPosition(paxis[SYSTEM_AXIS_Z_STATION_40_LEFT], AXIS_Z, &Last_position[SYSTEM_AXIS_Z_STATION_40_LEFT]); //Left
	...
	for (i=0; i<2; i++)
	{
		...
		EXCCHECKALLOC( pthread_data);
		pthread_data[i]->vi_DAQ = vi_DAQ;
		pthread_data[i]->paxis = paxis[i+8];
		pthread_data[i]->pcan = pcan;
		pthread_data[i]->timeout = 9000;
		pthread_data[i]->index = i;
		pthread_data[i]->station = station;
...
Error:
	...
	else if (pexception && ((STestParamPtr)pTID)->fault_retest == TRUE)
	{
		...
		/*high speed  ==> mouvement in direction - */
		paxis[SYSTEM_AXIS_Z_STATION_40_RIGHT]->SetPosition(paxis[SYSTEM_AXIS_Z_STATION_40_RIGHT], AXIS_Z, Last_position[SYSTEM_AXIS_Z_STATION_40_RIGHT], 100.0); //Right
		paxis[SYSTEM_AXIS_Z_STATION_40_RIGHT]->EnableAxis(paxis[SYSTEM_AXIS_Z_STATION_40_RIGHT], AXIS_Z);
								
		paxis[SYSTEM_AXIS_Z_STATION_40_LEFT]->SetPosition(paxis[SYSTEM_AXIS_Z_STATION_40_LEFT], AXIS_Z, Last_position[SYSTEM_AXIS_Z_STATION_40_LEFT], 100.0); //LEFT
		paxis[SYSTEM_AXIS_Z_STATION_40_LEFT]->EnableAxis(paxis[SYSTEM_AXIS_Z_STATION_40_LEFT], AXIS_Z);
	}
