...
#undef __FUNC__
#define __FUNC__	"PQ26_CLIMATRONIC::Initialize"
...
)
{
	...
	EXCCHECKCOM( MSXML_IXMLDOMDocumentselectNodes (xml_doc, NULL,
						"//module[@id='"MODULE_JIG_PQ26_CLIMATRONIC"']/Sensors/Sensor",
						&sensors_list)); 
	...
	EXCCHECKCOM( MSXML_IXMLDOMDocumentselectNodes (xml_doc, NULL,
						"//module[@id='"MODULE_JIG_PQ26_CLIMATRONIC"']/BarCodeReaders/BarCodeReader",
						&bcr_list));
	if (bcr_list)
	{
...
#undef __FUNC__
#define __FUNC__	"PQ26_CLIMATRONIC::Destroy"
...
#undef __FUNC__
#define __FUNC__	"PQ26_CLIMATRONIC::GetUUID"
SElExceptionPtr GetUUID(struct _SJig* me, char* uuid, uint32_t size)
{
	SElExceptionPtr	pexception = NULL;
	
	strncpy(uuid, MODULE_JIG_PQ26_CLIMATRONIC, size);
...
#undef __FUNC__
#define __FUNC__	"PQ26_CLIMATRONIC::ResetEnable"
SElExceptionPtr ResetEnable
(
	struct _SJig*	me,
	const char*		product,
	int32_t			timeout
)
{
	...
	EXCCHECK( me->jig_SetSensor(me, "ResetEnable", 1));
	
	if (timeout)
	{
		if(gs_Enabled && !gs_Disabled) goto Error;		
		EXCCHECK( me->eventFactory->GetEvent(me->eventFactory, EVNT_JIG_RESET_ENABLE, &hevent));	
...
#undef __FUNC__
#define __FUNC__	"PQ26_CLIMATRONIC::ResetDisable"
SElExceptionPtr ResetDisable
(
	struct _SJig*	me,
	const char*		product,
	int32_t			timeout
)
{
	...
	EXCCHECK( me->eventFactory->GetEvent(me->eventFactory, EVNT_JIG_RESET_DISABLE, &hevent));

	EXCCHECK( me->jig_SetSensor(me, "ResetEnable", 0));
...
/* Lock product */
#undef __FUNC__
#define __FUNC__	"PQ26_CLIMATRONIC::LockItem"
...
/* Unlock product */
#undef __FUNC__
#define __FUNC__	"PQ26_CLIMATRONIC::UnlockItem"
...
#undef __FUNC__
#define __FUNC__	"PQ26_CLIMATRONIC::ConnectToItem"
...
#undef __FUNC__
#define __FUNC__	"PQ26_CLIMATRONIC::DisconnectFromItem"
...
/* Connectors disconnect from product */
#undef __FUNC__
#define __FUNC__	"PQ26_CLIMATRONIC::ColdMarking"
...
#undef __FUNC__
#define __FUNC__	"PQ26_CLIMATRONIC::SetItemPosition"
...
/* Get JIG position */
#undef __FUNC__
#define __FUNC__	"PQ26_CLIMATRONIC::GetItemPosition"
...
#undef __FUNC__
#define __FUNC__	"PQ26_CLIMATRONIC::GetItemCode"
...
#undef __FUNC__
#define __FUNC__	"PQ26_CLIMATRONIC::GetSensor"
...
#undef __FUNC__
#define __FUNC__	"PQ26_CLIMATRONIC::SetSensor"
...
/* Get Attribute Int32 */
#undef __FUNC__
#define __FUNC__	"PQ26_CLIMATRONIC::GetAttributeInt32"
...
/* Set Attribute Int32 */
#undef __FUNC__
#define __FUNC__	"PQ26_CLIMATRONIC::SetAttributeInt32"
...
#undef __FUNC__
#define __FUNC__	"PQ26_CLIMATRONIC::GetAttributeBoolean"
...
#undef __FUNC__
#define __FUNC__	"PQ26_CLIMATRONIC::SetAttributeBoolean"
...
#undef __FUNC__
#define __FUNC__	"PQ26_CLIMATRONIC::JigThread"
