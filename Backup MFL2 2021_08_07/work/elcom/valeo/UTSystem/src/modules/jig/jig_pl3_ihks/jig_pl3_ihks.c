...
#undef __FUNC__
#define __FUNC__	"PL3_IHKS::Initialize"
...
)
{
	...
	EXCCHECKCOM( MSXML_IXMLDOMDocumentselectNodes (xml_doc, NULL,
						"//module[@id='"MODULE_JIG_PL3_IHKS"']/Sensors/Sensor",
						&sensors_list));
	...
	EXCCHECKCOM( MSXML_IXMLDOMDocumentselectNodes (xml_doc, NULL,
						"//module[@id='"MODULE_JIG_PL3_IHKS"']/BarCodeReaders/BarCodeReader",
						&bcr_list));
	if (bcr_list)
	{
...
#undef __FUNC__
#define __FUNC__	"PL3_IHKS::Destroy"
...
#undef __FUNC__
#define __FUNC__	"PL3_IHKS::GetUUID"
SElExceptionPtr GetUUID(struct _SJig* me, char* uuid, uint32_t size)
{
	SElExceptionPtr	pexception = NULL;
	
	strncpy(uuid, MODULE_JIG_PL3_IHKS, size);
...
/* Lock product */
#undef __FUNC__
#define __FUNC__	"PL3_IHKS::LockItem"
...
/* Unlock product */
#undef __FUNC__
#define __FUNC__	"PL3_IHKS::UnlockItem"
...
#undef __FUNC__
#define __FUNC__	"PL3_IHKS::ConnectToItem"
...
#undef __FUNC__
#define __FUNC__	"PL3_IHKS::DisconnectFromItem"
...
/* Connectors disconnect from product */
#undef __FUNC__
#define __FUNC__	"PL3_IHKS::ColdMarking"
...
#undef __FUNC__
#define __FUNC__	"PL3_IHKS::SetItemPosition"
...
/* Get JIG position */
#undef __FUNC__
#define __FUNC__	"PL3_IHKS::GetItemPosition"
...
#undef __FUNC__
#define __FUNC__	"PL3_IHKS::GetItemCode"
...
#undef __FUNC__
#define __FUNC__	"PL3_IHKS::GetSensor"
...
#undef __FUNC__
#define __FUNC__	"PL3_IHKS::SetSensor"
...
/* Get Attribute Int32 */
#undef __FUNC__
#define __FUNC__	"PL3_IHKS::GetAttributeInt32"
...
/* Set Attribute Int32 */
#undef __FUNC__
#define __FUNC__	"PL3_IHKS::SetAttributeInt32"
...
#undef __FUNC__
#define __FUNC__	"PL3_IHKS::GetAttributeBoolean"
...
#undef __FUNC__
#define __FUNC__	"PL3_IHKS::SetAttributeBoolean"
...
#undef __FUNC__
#define __FUNC__	"PL3_IHKS::JigThread"
