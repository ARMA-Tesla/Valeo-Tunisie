...
#undef __FUNC__
#define __FUNC__	"Toyota445L::Initialize"
...
)
{
	...
	EXCCHECKCOM( MSXML_IXMLDOMDocumentselectNodes (xml_doc, NULL,
						"//module[@id='"MODULE_JIG_445L"']/Sensors/Sensor",
						&sensors_list));
	...
	EXCCHECKCOM( MSXML_IXMLDOMDocumentselectNodes (xml_doc, NULL,
						"//module[@id='"MODULE_JIG_445L"']/BarCodeReaders/BarCodeReader",
						&bcr_list));
	if (bcr_list)
	{
...
#undef __FUNC__
#define __FUNC__	"Toyota445L::Destroy"
...
#undef __FUNC__
#define __FUNC__	"Toyota445L::GetUUID"
SElExceptionPtr GetUUID(struct _SJig* me, char* uuid, uint32_t size)
{
	SElExceptionPtr	pexception = NULL;
	
	strncpy(uuid, MODULE_JIG_445L, size);
...
/* Lock product */
#undef __FUNC__
#define __FUNC__	"Toyota445L::LockItem"
...
/* Unlock product */
#undef __FUNC__
#define __FUNC__	"Toyota445L::UnlockItem"
...
)
{
	...
	EXCCHECK( me->eventFactory->GetEvent(me->eventFactory, EVNT_JIG_ITEM_UNLOCK, &h_event));

	EXCCHECK( me->jig_SetSensor(me, "LockValve", 0));
	if (timeout)
	{
		if(!gs_locked && gs_unlocked)	goto Error;
		if (WaitForSingleObject( h_event, timeout) == WAIT_TIMEOUT)
		{
			if(!gs_locked && gs_unlocked)	goto Error;
			EXCTHROW( JIG_ERROR_TIMEOUT, "Function Timeouted");
		}
...
#undef __FUNC__
#define __FUNC__	"Toyota445L::ConnectToItem"
...
#undef __FUNC__
#define __FUNC__	"Toyota445L::DisconnectFromItem"
...
/* Connectors disconnect from product */
#undef __FUNC__
#define __FUNC__	"Toyota445L::ColdMarking"
...
#undef __FUNC__
#define __FUNC__	"Toyota445L::SetItemPosition"
...
/* Get JIG position */
#undef __FUNC__
#define __FUNC__	"Toyota445L::GetItemPosition"
...
#undef __FUNC__
#define __FUNC__	"Toyota445L::GetItemCode"
...
#undef __FUNC__
#define __FUNC__	"Toyota445L::GetSensor"
...
#undef __FUNC__
#define __FUNC__	"Toyota445L::SetSensor"
...
/* Get Attribute Int32 */
#undef __FUNC__
#define __FUNC__	"Toyota445L::GetAttributeInt32"
...
/* Set Attribute Int32 */
#undef __FUNC__
#define __FUNC__	"Toyota445L::SetAttributeInt32"
...
#undef __FUNC__
#define __FUNC__	"Toyota445L::GetAttributeBoolean"
...
#undef __FUNC__
#define __FUNC__	"Toyota445L::SetAttributeBoolean"
...
#undef __FUNC__
#define __FUNC__	"Toyota445L::JigThread"
...
)
{
	...
	EXCCHECK( me->jig_GetSensor(me, "IsPanelLock_Left",  &lock1));
	EXCCHECK( me->jig_GetSensor(me, "IsPanelLock_Right", &lock3));
	if (lock1 && lock3 )
	{
	...
	EXCCHECK( me->jig_GetSensor(me, "IsPanelUnlock_Left", &lock1));
	EXCCHECK( me->jig_GetSensor(me, "IsPanelUnlock_Right", &lock3));
	if (lock1 && lock3)
	{
